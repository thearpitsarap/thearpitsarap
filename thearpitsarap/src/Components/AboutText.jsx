...
const AboutText = () => {
    return (
        <div className='mx-10'>
            <p className='font-bold text-red-700 md:text-left text-2xl text-center md:text-5xl my-4 mx-7'>
                About Me:
            </p>
            <div className='text-blue-950 text-justify mx-7 my-4 leading-5 tracking-wide'>
            ...
            <div className='text-blue-950 text-justify my-4 mx-7 leading-5 tracking-wide'>
